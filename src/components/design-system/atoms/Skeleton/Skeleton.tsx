import type { SkeletonProps, ChartSkeletonProps, BarsSkeletonProps, HeatmapSkeletonProps } from './types';
...
export function ChartSkeleton({ heightClass = 'h-[260px]' }: ChartSkeletonProps) {
...
export function BarsSkeleton({ rows = 6 }: BarsSkeletonProps) {
  return (
...
export function HeatmapSkeleton({ weeks = 18 }: HeatmapSkeletonProps) {
  return (
    <div>
