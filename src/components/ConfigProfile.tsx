...
export function ConfigProfile({ config }: { config: ClaudeConfig | null }) {
      ...
      <div className="space-y-2.5 mb-4 text-xs flex-none">
        <div className="flex justify-between items-center py-1.5 border-b border-white/5">
          ...
          <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${
            config.voiceEnabled ? 'bg-emerald-500/10 text-emerald-400' : 'bg-zinc-800 text-zinc-500'
          }`}>
        ...
        <div className="flex justify-between items-center py-1.5 border-b border-white/5">
          ...
          <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${
            config.remoteControlAtStartup ? 'bg-emerald-500/10 text-emerald-400' : 'bg-zinc-800 text-zinc-500'
          }`}>
