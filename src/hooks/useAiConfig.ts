...
export const PROVIDER_MODELS: Record<AiProvider, string[]> = {
  claude: ['claude-fable-5-1', 'claude-opus-5-5', 'claude-opus-5', 'claude-opus-4-8', 'claude-sonnet-5', 'claude-sonnet-4-6', 'claude-haiku-4-5-20251001'],
  openai: ['gpt-6-sol', 'gpt-6-astra', 'gpt-6-luna', 'gpt-4.1', 'o4-mini'],
